...
public class CreateProfileFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        getActivity().setTitle(R.string.profile_creation_title);
        getActivity().findViewById(R.id.bottom_navigation).setVisibility(View.GONE);
        ((MainActivity) getActivity()).showBack(true);

        Button nextButton = getActivity().findViewById(R.id.profileCreationNextButton);

        nextButton.setOnClickListener(new Button.OnClickListener() {
            public void onClick(View v) {
                ((MainActivity) getActivity()).getNavController().navigate(R.id.action_createProfileFragment_to_profileFragment);
            }
        });
    }
}