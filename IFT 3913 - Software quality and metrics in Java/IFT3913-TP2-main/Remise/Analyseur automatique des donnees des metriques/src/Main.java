...
public class Main {
    public static void main(String[] args) throws IOException, ParseException {
        ...
        // Ceci sont les scores pour les 4 questions de l'énoncé.
        // Le score peut-être : 0/2, 1/2 ou 2/2. Seul le cas 2/2 sera retenu plus tard comme étant satisfaisant.
        // Chaque question utilise 2 métriques. Si le seuil d'une métrique est respectée, alors score + 1
        int q1 = 0;
        int q2 = 0;
        int q3 = 0;
        int q4 = 0;
        ...
        // Cette partie du code calcul le temps de test et le nombre de tests: (préalable : outil Junit4)
        ...
        try{
            String tempsTestText = utils.findWordLineInFile(input, "<testrun duration=", 1, true);
            ...
            finalResult+= "\nTemps de test et nombre de tests avec le fichier " + input + "\nTemps de test :" + duration + "ms\nNombre total de tests : " + total +"\n";


            if (Integer.valueOf(duration) < 50000){
                q4++;
                finalResult+="La durée est inférieur à 5000ms, donc la note de la question 4 est maintenant :" + q4 + "/2\n";
            }
        }
        catch(Exception e){
            System.out.println( input + " est un chemin ou fichier invalide");
        }
        printSeparator();
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        // Cette partie du code calcul % méthodes non testées PMNT (préalable : outil Junit4):
        ...
        // Cette partie du code calcul CBO et LCOM: (préalable : outil externe ck)
        Map<String, Map<String, String>> ckMap;
        ArrayList<ArrayList<String>> ckOut;
        System.out.println("Calculer CBO & LCOM :\n");
        System.out.println("Donnez le chemin complet du fichier outputclass.csv généré par l'outil ck, Exemple : \nC:\\Users\\leade\\Desktop\\IFT3913-TP2\\Metrics Data\\ck\\outputclass.csv");
        input = scanner.nextLine();
        try{
            ckOut = utils.readCsv(input);
            ...
            finalResult+= "\nCbo & Lcom avec  le fichier " + input + "\ncbo moyenne :" + cboM +  "\nlcom* moyenne :" + lcomM + "\n" ;
        ...
        // Cette partie du code calcul la densité de commentaire et le nombre de commentaires par méthode (préalable : notre outil et l'outil externe ck)
        ...
        try{
            ckOut = utils.readCsv(input);
            ckMap = utils.listToMap(ckOut);
            ArrayList<ArrayList<String>> cdOut = utils.readCsv(inputExtra);
            ...
            System.out.println(input + " ou " + inputExtra + " est invalide.");
        }
        printSeparator();
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////


        // Cette partie du code calcul l'âge du projet en cherchant la date la plus récente: (préalable : notre outil)
        ...
        input = scanner.nextLine();
        try{ArrayList<ArrayList<String>> cdateOut = utils.readCsv(input);
