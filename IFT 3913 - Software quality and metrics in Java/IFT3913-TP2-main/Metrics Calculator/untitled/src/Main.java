...
public class Main {
    ...
    public static void main(String[] args) throws IOException, ParseException {
        ...
        input = scanner.nextLine();
        try{
            //String pmntText = utils.findWordLineInFile("C:\\Users\\leade\\Desktop\\IFT3913-TP2\\Metrics Data\\JUnit4\\Coverage Report\\index.html", "<td class=\"name\">all classes</td>", 12, true);
        ...
        try{
            ...
            // Attribuer score
            if ( (0.2 < (cd/cdMap.size())) && ((cd/cdMap.size()) < 0.4)){
                q1++;
                finalResult+="La densité de commentaire est entre 0.2 et 0.4, donc la note de la question 1 est maintenant :" + q1 + "/2\n";
            }
            if ((0.2 < (commentsPerMethod / count)) && ((commentsPerMethod / count)< 0.4)){
                q1++;
                finalResult+="La nombre de commentaire par méthode est entre 0.2 et 0.4, donc la note de la question 1 est maintenant :" + q1 + "/2\n";
            }
