...
void main() {
    ...
    // Pour Phong, nous allons faire tous nos calculs dans le fragment shaders.
    // Note : nous avons besoin d'envoyer au fragment shader v & n :
    v = normalize(-relativeVertexPosition.xyz);
