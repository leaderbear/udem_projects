...
var armadilloMaterial = new THREE.ShaderMaterial({
	uniforms: {
		...
		controller0 : remotePosition0, // Ici, je veux passer les coordonnées de chacuns des controlleurs aux
		controller1 : remotePosition1, // aux shaders séparément. Afin d'obtenir plus tard leurs hauteurs et
		controller2 : remotePosition2, // créer la perturbation de la géométrie
	}
});
