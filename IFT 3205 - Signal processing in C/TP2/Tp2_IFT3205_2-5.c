...
#define NAME_IMG_IN2  "image-TpIFT3205-2-4"         // TODO : use 2-4 image or rotate it again ? 
...
int main(int argc,char **argv)
 {
  ...
  float** MatriceImg2=LoadImagePgm(NAME_IMG_IN1,&length,&width); // Image deja retourné 
