...
int main(int argc,char **argv)
 {
  ...
  // Image initiale 
  saveImage(MatriceImg1,length,width,"0", 1);


  // Itérations de filtrage
  applyFilter(MatriceImg1,MatriceImg2,length,width,0, 0, 512, 512, 0.04f);
  saveImage(MatriceImg2,length,width,"1", 1);

  applyFilter(MatriceImg1,MatriceImg2,length,width,128, 128, 256, 256, 0.02f);
  saveImage(MatriceImg2,length,width,"2", 1);

  applyFilter(MatriceImg1,MatriceImg2,length,width,128, 240, 256, 256, 0.01f);
  saveImage(MatriceImg2,length,width,"3", 1);

  applyFilter(MatriceImg1,MatriceImg2,length,width, 128, 168, 256, 256, 0.005f);
  saveImage(MatriceImg2,length,width,"4", 1);

  applyFilter(MatriceImg1,MatriceImg2,length,width,128, 200, 256, 256, 0.0025f);
  saveImage(MatriceImg2,length,width,"5", 1);
